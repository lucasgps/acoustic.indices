...
m<-predict(mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env.landid )
x <-mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env.landid@frame$BIO_1000_12000_FFT512
y <-mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env.landid@frame$NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512
z <- mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env.landid@frame$sample_rich
d<-as.data.frame(cbind(m, x, y))

f<-seq(range(d$x)[1],range(d$x)[2], length=100)
s<-seq(range(d$y)[1],range(d$y)[2], length=65)
fs<-expand.grid(f,s)
colnames(fs)<-c("BIO_1000_12000_FFT512","NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512")

psi<-data.frame(predict(mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env.landid), newdata=fs)
...
plot_rich_01 <-ggplot(data=psi, aes(x=BIO_1000_12000_FFT512 , y=NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512 , z=Predicted))+
  ...
  labs(fill = "Species \nrichness")
plot_rich_01
png("./plots/models/01_mod.riq.BIO.NDSI.env.png", width=900, height=900)
plot_rich_01
dev.off()

# mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512.env.landid
m<-predict(mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512.env.landid )
x <-mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512.env.landid@frame$BIO_1000_12000_FFT512 
y <-mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512.env.landid@frame$AR
z <- mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512.env.landid@frame$env
d<-as.data.frame(cbind(m, x, y))
...
View(m)
psi<-data.frame(predict(mod.riq.BIO_1000_12000_FFT512.AR.env.landid , newdata=fs))
colnames(psi)<-"Predicted"
...
x <-mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512@frame$ADI_300_12000_75db
z <- mod.riq.ADI_300_12000_75db.BIO_1000_12000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.riq.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.riq.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512@frame$ACI_1000_12000_FFT512
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512@frame$NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512
z <- mod.riq.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.abund.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.abund.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512@frame$ACI_1000_12000_FFT512
z <- mod.abund.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.abund.BIO_1000_12000_FFT512.AR@frame$BIO_1000_12000_FFT512 
y <-mod.abund.BIO_1000_12000_FFT512.AR@frame$AR
z <- mod.abund.BIO_1000_12000_FFT512.AR.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.abund.ADI_300_12000_75db.BIO_1000_12000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.abund.ADI_300_12000_75db.BIO_1000_12000_FFT512@frame$ADI_300_12000_75db
z <- mod.abund.ADI_300_12000_75db.BIO_1000_12000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.abund.AEI_1000_12000_50db.BIO_1000_12000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.abund.AEI_1000_12000_50db.BIO_1000_12000_FFT512@frame$AEI_1000_12000_50db
z <- mod.abund.AEI_1000_12000_50db.BIO_1000_12000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.abund.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.abund.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512@frame$NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512
z <- mod.abund.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.invsimp.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.invsimp.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512@frame$ACI_1000_12000_FFT512
z <- mod.invsimp.ACI_1000_12000_FFT512.BIO_1000_12000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.invsimp.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512@frame$BIO_1000_12000_FFT512 
y <-mod.invsimp.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512@frame$NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512
z <- mod.invsimp.BIO_1000_12000_FFT512.NDSI_AMAX2000_AMIN1000_BMAX22050_BMIN2000_FFT512.env@frame$env
d<-as.data.frame(cbind(m, x, y))
...
x <-mod.invsimp.BIO_1000_12000_FFT512.AR@frame$BIO_1000_12000_FFT512 
y <-mod.invsimp.BIO_1000_12000_FFT512.AR@frame$AR
z <- mod.invsimp.BIO_1000_12000_FFT512.AR.env@frame$env
d<-as.data.frame(cbind(m, x, y))
