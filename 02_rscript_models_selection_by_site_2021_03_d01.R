...
mestra_birds_variables 
colnames(mestra_birds_variables )

## VIF Analisys!!Reduce colinearity

# VIF rich  -------------------------------------
mestra_birds_rich <- mestra_birds %>% 
  dplyr::select(ADI_300_12000_50db:AR, sample_rich)
colnames(mestra_birds_rich)
...
# save
write.csv2(results_birds.multiple.env, "00_model_selection_AIC_birds_by_landscape_multiple_indices_without_enviroment_2021_03_d01.csv")
...
write.csv2(results_birds.multiple.env, "00_model_selection_AIC_birds_by_landscape_multiple_indices_without_enviroment_2021_03_d01_all_data.csv")
